...
# 是否启用 KDTree 插值 (替代 Qhull LinearNDInterpolator)
USE_KD_TREE_INTERPOLATION: bool = True

# KDTree 查询的近邻数量 (推荐 12, 2D 空间的最优平衡点)
KNN_K: int = 12

# 共线性检测阈值 (PCA 第二/第一主成分方差比)
# 低于此值判定近邻近似共线, 降级到三角形顶点插值
COLLINEARITY_THRESHOLD: float = 1e-8

# np.linalg.lstsq 的截断阈值 (rcond)
LSQ_RCOND: float = 1e-12
