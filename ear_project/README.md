...
│   ├── __init__.py              ← 包初始化
│   ├── config.py                ← 全局配置常量
│   ├── core.py                  ← ★ 核心算法（退化检测/投影/面片构建/插值/QC）
│   ├── synthetic.py             ← 模拟数据生成
...
| `ear_param/config.py` | 87 | 所有可调参数集中管理 |
...
2026-07-06 10:00:00 | INFO    | 项目根目录: D:\YHC\人头项目\ear_project
2026-07-06 10:00:00 | INFO    | ============================================================
2026-07-06 10:00:00 | INFO    | 
2026-07-06 10:00:00 | INFO    | ============================================================
...
1. **二维展开 (UV Unwrapping)**：将采样点从重心坐标 (λ_b, λ_c) 展开为 (u, v) 坐标（当前为 NaN 列预留）。
